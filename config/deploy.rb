...
set :user, "user93262162"


# allow SSH-Key-Forwarding
set :ssh_options, { :forward_agent => true }  
ssh_options[:keys] = [File.join(ENV["HOME"], ".ssh", "2011")]
...
# repository location
set :repository, "git@github.com:pshizzle/mfm-institut.git"
...
set :deploy_to, "/home/user93262162/rails1"
...
namespace :railshoster do
  ...
  task :appurl do
    ...
    puts "\nhttp://user93262162-1.rho.railshoster.de"    
    puts "\n"
  end
end
